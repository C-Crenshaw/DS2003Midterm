...
## Conclusion
While we had some prior basketball knowledge and underlying assumptions, the outcome of the data analysis surprised us. There was a positive trend for the impacts on team effective field goal percentage and team free throw rates on a teams total points scored, which was expected. However, we came to the conclusion that team effective field percentage is a better indicator of team score than team free throw rate. Our prediction was that fouls led to free throws, which would increase the free throw rate and therefore the team score. Over the past three seasons, free throw rates have had less of an impact on team score while effective field goal percentage has maintained a strong positive relationship with team score.
